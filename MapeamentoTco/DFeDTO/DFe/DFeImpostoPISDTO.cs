...
{
    public class DFeImpostoPISDTO
    {
        public int? situacaoTributariaPIS { get; set; }
        ...
        public decimal quantidadeBaseCalculoPIS { get; set; }
        public decimal valorPautadoPIS { get; set; }
        public decimal valorPIS { get; set; }
        public decimal valorImportacaoPIS { get; set; }
    }
}